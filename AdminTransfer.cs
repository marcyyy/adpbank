...
namespace adpbank
{
    ...
    {
        public AdminTransfer(string un_admin, string un_id)
        {
            InitializeComponent();
            // client username
        ...
        private void AdminHome_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // table
                string query1 = "select *, DATE_FORMAT(tF_dt, '%Y-%m-%d') AS 'Date Created' from transfer INNER JOIN accounts_client ON transfer.client_id = accounts_client.id where accounts_client.active = '1' ORDER BY transfer.id ASC ";
