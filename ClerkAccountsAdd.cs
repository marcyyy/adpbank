...
namespace adpbank
{
    public partial class ClerkAccountsAdd : Form
    {
        public ClerkAccountsAdd(string un_admin, string un_id)
        {
            InitializeComponent();
            // client username
        ...
        private void confirmBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    this.Hide();
                    var clerkAccounts = new ClerkHome(userLabel.Text, adminID.Text);
                    clerkAccounts.Closed += (s, args) => this.Close();
                    clerkAccounts.Show();
