...
namespace adpbank
{
    public partial class AdminAllTransaction : Form
    {
        public AdminAllTransaction(string un_admin, string un_id, string accnum)
        {
            InitializeComponent();
            // client username
            ...
            if (dpTB.Text == "")
                ...
                else
                {
                    try
                    {
                        ...
                        this.Hide();
                        var adminTransaction = new AdminTransaction(userLabel.Text, cidLabel.Text);
                        adminTransaction.Closed += (s, args) => this.Close();
                        adminTransaction.Show();
        ...
        private void tfBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("Recipient Account Number is invalid.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
