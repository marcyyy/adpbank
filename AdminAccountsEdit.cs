...
namespace adpbank
{
    public partial class AdminAccountsEdit : Form
    {
        public AdminAccountsEdit(string un_admin, string un_id, string cl_id)
        {
            InitializeComponent();
            // client username
        ...
        {
            this.Hide();
            var adminAccounts_edit = new AdminPassword2(userLabel.Text, adminID.Text, cnidLabel.Text);
