...
namespace adpbank
{
    public partial class AdminPassword2 : Form
    {
        public AdminPassword2(string un_admin, string un_id, string cl_id)
        {
            InitializeComponent();
            // client username
            cidLabel.Text = cl_id;
        ...
        private void confirmBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dbConn.Open();
                string query = "UPDATE accounts_client SET password = '" + unTB.Text + "' " +
